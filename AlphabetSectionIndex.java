...
public class AlphabetSectionIndex extends RecyclerView {
    ...
    public ND_SectionIndex(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    class SectionIndexAdapter extends RecyclerView.Adapter<SectionIndexAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = mInflater.inflate(R.layout.nd_item_letter, parent, false);
        ...
        class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View view) {
                if (sectionIndexClickListener != null) {
                    sectionIndexClickListener.onItemClick(view, this.getPosition());
                }
            }
        }
    }
